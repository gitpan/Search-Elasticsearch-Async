...
$Search::Elasticsearch::Role::Is_Async::VERSION = '1.18';
use Moo::Role;
use namespace::clean;
...
Search::Elasticsearch::Role::Is_Async - A role to mark classes which should be used with other async classes
