...
$Search::Elasticsearch::Async::Bulk::VERSION = '1.18';
use Moo;
...
This module provides an async wrapper for the L<Search::Elasticsearch::Client::Direct/bulk()>
...
a L<bulk()|Search::Elasticsearch::Client::Direct/bulk()> request and returns
